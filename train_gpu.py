...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'DVT training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=2, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='DVT_vit_base_patch14_224', type=str, metavar='MODEL',
                        choices=['DVT_vit_base_patch16_224', 'DVT_vit_base_patch14_224',
                                 'DVT_vit_base_patch32_224', 'DVT_vit_huge_patch14_224',
                                 'DVT_vit_large_patch16_224','DVT_vit_large_patch32_224'
                                 ],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'DVT training and evaluation script', parents=[get_args_parser()])
